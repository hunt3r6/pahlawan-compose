package com.example.pahlawan.data
...
var listHeroes = listOf(
    ...
    Hero(
        ...
        photo = R.drawable.gatot_subroto
    ),
    Hero(
        ...
        photo = R.drawable.ki_hadjar_dewantara
    ),
    Hero(
        name = "Mohammad Hatta",
        ...
        photo = R.drawable.mohammad_hatta
    ),
    Hero(
        name = "Soedirman",
